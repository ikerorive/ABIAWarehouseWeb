<div class="container" style="width: 100%">
	...
	<script type="text/javascript">
		var miArray =
	<%=session.getAttribute("dataCurrentOrders")%>
		;
		console.log(miArray);
		var yearRingChart = dc.pieChart("#chart-ring-year"), spendHistChart = dc
				.barChart("#chart-hist-spend").xAxisLabel('Products'), orderHistChart = dc
				.barChart("#chart-hist-order").xAxisLabel('Orders'), spenderRowChart = dc
		...
		orderHistChart.dimension(orderDim).group(spenPerOrder)
				.x(d3.scaleBand()).xUnits(dc.units.ordinal).elasticY(true)
				.controlsUseVisibility(true);
