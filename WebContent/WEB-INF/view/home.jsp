...
<!-- Jumbotron -->
<!-- <div id="jumbotron"
	style="background-image: url(resources/img/MisguidedDapperJackal-small.gif); height: 100%;
...
<div id="insideJumbotron"
	...
	<div class="py-5">
		...
		<p class="mb-4 pb-2 px-md-5 mx-md-5">ABIA warehouse is the next
			level, fully automated warehouse solution you, your company and all your friends
			need.</p>
		...
		<a class="btn peach-gradient"
			...
			class="fas fa-clone left"></i>Contact us!</a>
